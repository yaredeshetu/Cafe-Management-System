...
public class Waiter_Report extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.waiter_report, container, false);
        tabLayout=(TabLayout)root.findViewById(R.id.tabLayout);
        frameLayout=(FrameLayout)root.findViewById(R.id.frameLayout);

        fragment = new Daily_Waiter_Balance();
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        ...
                        fragment = new TransactionReport();
                        break;
                    case 2:
