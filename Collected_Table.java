...
public class Collected_Table extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.collected_table, container, false);
        try {
        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try
                {
                    MainActivity.selectedWaiter1=new ArrayList();
                    for (int i=0;i<linearLayout.getChildCount();i++)
                    {
                        ...
                        if(chch.isChecked())
                        {
                            ...
                            MainActivity.selectedWaiter1.add(s8);
                        }
                    }
                    SelectRR1=1;
                    appendRow1(table,"");
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                int ckck=0;
                for(int i=0;i<MainActivity.selectedWaiter1.size();i++)
                {
                    if(userN.equalsIgnoreCase(MainActivity.selectedWaiter1.get(i).toString()))
                    {
                        ckck=1;
                    }
                }
    ...
    private static ArrayList search4(String str)
    {
        ...
        try
        {
            ...
            while (rs.next())
            {
                ...
                for (int i=0;i<MainActivity.selectedWaiter1.size();i++)
                {
                    if(wait.equalsIgnoreCase(MainActivity.selectedWaiter1.get(i).toString()))
                    {
                        ckc=1;
                    }
                }
